...
var regexNumber = /^[0-9]{0,9}(\.[0-9]{1,2})?$/;
...
(function () {
    ...
    if (ctrl.GetLanguage() == "es") {
        ...
        validate.validators.format.message = "Es inválido";
        validate.validators.length.notValid = "No es válido. Tiene que ser de %{count} caracteres";
        validate.validators.length.tooLong = "Es muy largo. Tiene que ser de %{count} caracteres";
        validate.validators.length.tooShort = "Es muy corto. Tiene que ser de %{count} caracteres";
        validate.validators.length.wrongLength = "Es de tamaño incorrecto. Tiene que ser de %{count} caracteres";
    }
    ...
    function createConstraints() {
        var constraints = {
            ...
            presupuesto: {
                presence: document.querySelector("input#checkPresupuesto[name='checkPresupuesto']").checked,
                length: {
                    maximum: 10
                },
                format: {
    ...
    var form = document.querySelector("form#form-solicitud");
    ...
    function showSuccess() {
        ...
        editarSolicitud.UpdateSolicitud();
    }
})();
